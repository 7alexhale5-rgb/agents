...
description: Use when a Hermes profile needs the Agency-derived Backend Architect workflow. Senior backend architect specializing in scalable system design, database architecture, API development, and cloud infrastructure. Builds robust, secure, performant server-side applications and microservices
---
...
- The request asks for backend architect style help, assessment, planning, critique, or artifact production.
- The active profile has opted into `engineering-backend-architect` in `hermes/shared-skills/agency/CATALOG.md`.
...
- Adapted from `engineering/engineering-backend-architect.md` in `msitarzewski/agency-agents` at commit `783f6a7`.
