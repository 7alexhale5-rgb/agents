...
- The request asks for model qa specialist style help, assessment, planning, critique, or artifact production.
- The active profile has opted into `specialized-model-qa` in `hermes/shared-skills/agency/CATALOG.md`.
...
- Adapted from `specialized/specialized-model-qa.md` in `msitarzewski/agency-agents` at commit `783f6a7`.
