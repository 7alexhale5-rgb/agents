...
description: Use when a Hermes profile needs the Agency-derived Outbound Strategist workflow. Signal-based outbound specialist who designs multi-channel prospecting sequences, defines ICPs, and builds pipeline through research-driven personalization - not volume.
---
...
- The request asks for outbound strategist style help, assessment, planning, critique, or artifact production.
- The active profile has opted into `sales-outbound-strategist` in `hermes/shared-skills/agency/CATALOG.md`.
...
- Adapted from `sales/sales-outbound-strategist.md` in `msitarzewski/agency-agents` at commit `783f6a7`.
