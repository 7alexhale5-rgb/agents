...
description: Use when a Hermes profile needs the Agency-derived Database Optimizer workflow. Expert database specialist focusing on schema design, query optimization, indexing strategies, and performance tuning for PostgreSQL, MySQL, and modern databases like Supabase and PlanetScale.
---
...
- The request asks for database optimizer style help, assessment, planning, critique, or artifact production.
- The active profile has opted into `engineering-database-optimizer` in `hermes/shared-skills/agency/CATALOG.md`.
...
- Adapted from `engineering/engineering-database-optimizer.md` in `msitarzewski/agency-agents` at commit `783f6a7`.
