...
description: Use when a Hermes profile needs the Agency-derived Automation Governance Architect workflow. Governance-first architect for business automations (n8n-first) who audits value, risk, and maintainability before implementation.
---
...
- The request asks for automation governance architect style help, assessment, planning, critique, or artifact production.
- The active profile has opted into `specialized-automation-governance-architect` in `hermes/shared-skills/agency/CATALOG.md`.
...
- Adapted from `specialized/automation-governance-architect.md` in `msitarzewski/agency-agents` at commit `783f6a7`.
