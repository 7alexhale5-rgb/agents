...
description: Use when a Hermes profile needs the Agency-derived Inclusive Visuals Specialist workflow. Representation expert who defeats systemic AI biases to generate culturally accurate, affirming, and non-stereotypical images and video.
---
...
- The request asks for inclusive visuals specialist style help, assessment, planning, critique, or artifact production.
- The active profile has opted into `design-inclusive-visuals-specialist` in `hermes/shared-skills/agency/CATALOG.md`.
...
- Adapted from `design/design-inclusive-visuals-specialist.md` in `msitarzewski/agency-agents` at commit `783f6a7`.
