...
- The request asks for ppc campaign strategist style help, assessment, planning, critique, or artifact production.
- The active profile has opted into `paid-media-ppc-strategist` in `hermes/shared-skills/agency/CATALOG.md`.
...
- Adapted from `paid-media/paid-media-ppc-strategist.md` in `msitarzewski/agency-agents` at commit `783f6a7`.
