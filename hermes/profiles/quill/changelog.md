...
- Identity: SOUL / DOCTRINE / USER / MEMORY written against marketing vault
  (voice-and-anti-slop, prettyfly-company-truth, copy-review-checklist,
  content-pillars, kill-list, AI Ops Audit campaign)
- Router: CLAUDE.md with 5-task routing + 3-tier model routing (nvidia free /
  sonnet-4-6 / opus-4-7) + 11 hard rules
- Config: tools.contracts.draft.propose.event block per Marin + patch #5 pattern
  (silo_slug=skills, cwd_project=marketing)
- Skills: 5 flat MD (README, draft-linkedin-field-note, draft-outreach-message,
  draft-campaign-asset, revise-from-critique)
