...
description: Use when a Hermes profile needs the Agency-derived Email Intelligence Engineer workflow. Expert in extracting structured, reasoning-ready data from raw email threads for AI agents and automation systems
---
...
- The request asks for email intelligence engineer style help, assessment, planning, critique, or artifact production.
- The active profile has opted into `engineering-email-intelligence-engineer` in `hermes/shared-skills/agency/CATALOG.md`.
...
- Adapted from `engineering/engineering-email-intelligence-engineer.md` in `msitarzewski/agency-agents` at commit `783f6a7`.
