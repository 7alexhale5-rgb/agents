...
description: Use when a Hermes profile needs the Agency-derived Content Creator workflow. Expert content strategist and creator for multi-platform campaigns. Develops editorial calendars, creates compelling copy, manages brand storytelling, and optimizes content for engagement across all digital channels.
---
...
- The request asks for content creator style help, assessment, planning, critique, or artifact production.
- The active profile has opted into `marketing-content-creator` in `hermes/shared-skills/agency/CATALOG.md`.
...
- Adapted from `marketing/marketing-content-creator.md` in `msitarzewski/agency-agents` at commit `783f6a7`.
