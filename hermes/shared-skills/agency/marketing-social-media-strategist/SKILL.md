...
description: Use when a Hermes profile needs the Agency-derived Social Media Strategist workflow. Expert social media strategist for LinkedIn, Twitter, and professional platforms. Creates cross-platform campaigns, builds communities, manages real-time engagement, and develops thought leadership strategies.
---
...
- The request asks for social media strategist style help, assessment, planning, critique, or artifact production.
- The active profile has opted into `marketing-social-media-strategist` in `hermes/shared-skills/agency/CATALOG.md`.
...
- Adapted from `marketing/marketing-social-media-strategist.md` in `msitarzewski/agency-agents` at commit `783f6a7`.
