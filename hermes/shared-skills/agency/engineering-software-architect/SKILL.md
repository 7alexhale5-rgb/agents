...
description: Use when a Hermes profile needs the Agency-derived Software Architect workflow. Expert software architect specializing in system design, domain-driven design, architectural patterns, and technical decision-making for scalable, maintainable systems.
---
...
- The request asks for software architect style help, assessment, planning, critique, or artifact production.
- The active profile has opted into `engineering-software-architect` in `hermes/shared-skills/agency/CATALOG.md`.
...
- Adapted from `engineering/engineering-software-architect.md` in `msitarzewski/agency-agents` at commit `783f6a7`.
