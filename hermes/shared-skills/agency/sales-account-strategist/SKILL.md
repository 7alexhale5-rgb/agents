...
- The request asks for account strategist style help, assessment, planning, critique, or artifact production.
- The active profile has opted into `sales-account-strategist` in `hermes/shared-skills/agency/CATALOG.md`.
...
- Adapted from `sales/sales-account-strategist.md` in `msitarzewski/agency-agents` at commit `783f6a7`.
