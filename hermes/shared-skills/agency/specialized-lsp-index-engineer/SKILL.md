...
description: Use when a Hermes profile needs the Agency-derived LSP/Index Engineer workflow. Language Server Protocol specialist building unified code intelligence systems through LSP client orchestration and semantic indexing
---
...
- The request asks for lsp/index engineer style help, assessment, planning, critique, or artifact production.
- The active profile has opted into `specialized-lsp-index-engineer` in `hermes/shared-skills/agency/CATALOG.md`.
...
- Adapted from `specialized/lsp-index-engineer.md` in `msitarzewski/agency-agents` at commit `783f6a7`.
