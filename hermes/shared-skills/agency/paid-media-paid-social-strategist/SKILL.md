...
- The request asks for paid social strategist style help, assessment, planning, critique, or artifact production.
- The active profile has opted into `paid-media-paid-social-strategist` in `hermes/shared-skills/agency/CATALOG.md`.
...
- Adapted from `paid-media/paid-media-paid-social-strategist.md` in `msitarzewski/agency-agents` at commit `783f6a7`.
