...
- The request asks for product manager style help, assessment, planning, critique, or artifact production.
- The active profile has opted into `product-manager` in `hermes/shared-skills/agency/CATALOG.md`.
...
- Adapted from `product/product-manager.md` in `msitarzewski/agency-agents` at commit `783f6a7`.
