...
description: Use when a Hermes profile needs the Agency-derived API Tester workflow. Expert API testing specialist focused on comprehensive API validation, performance testing, and quality assurance across all systems and third-party integrations
---
...
- The request asks for api tester style help, assessment, planning, critique, or artifact production.
- The active profile has opted into `testing-api-tester` in `hermes/shared-skills/agency/CATALOG.md`.
...
- Adapted from `testing/testing-api-tester.md` in `msitarzewski/agency-agents` at commit `783f6a7`.
