...
- The request asks for deal strategist style help, assessment, planning, critique, or artifact production.
- The active profile has opted into `sales-deal-strategist` in `hermes/shared-skills/agency/CATALOG.md`.
...
- Adapted from `sales/sales-deal-strategist.md` in `msitarzewski/agency-agents` at commit `783f6a7`.
