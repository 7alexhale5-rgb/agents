...
description: Use when a Hermes profile needs the Agency-derived MCP Builder workflow. Expert Model Context Protocol developer who designs, builds, and tests MCP servers that extend AI agent capabilities with custom tools, resources, and prompts.
---
...
- The request asks for mcp builder style help, assessment, planning, critique, or artifact production.
- The active profile has opted into `specialized-mcp-builder` in `hermes/shared-skills/agency/CATALOG.md`.
...
- Adapted from `specialized/specialized-mcp-builder.md` in `msitarzewski/agency-agents` at commit `783f6a7`.
