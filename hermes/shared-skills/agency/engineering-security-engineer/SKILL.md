...
description: Use when a Hermes profile needs the Agency-derived Security Engineer workflow. Expert application security engineer specializing in threat modeling, vulnerability assessment, secure code review, security architecture design, and incident response for modern web, API, and cloud-native applications.
---
...
- The request asks for security engineer style help, assessment, planning, critique, or artifact production.
- The active profile has opted into `engineering-security-engineer` in `hermes/shared-skills/agency/CATALOG.md`.
...
- Adapted from `engineering/engineering-security-engineer.md` in `msitarzewski/agency-agents` at commit `783f6a7`.
