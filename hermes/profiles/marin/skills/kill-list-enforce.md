...
output: 5-line memo (inline response or written to ~/Projects/marketing/_inbox/marin-readouts/{YYYY-MM-DD}-kill-check-{slug}.md if long)
---
...
3. `~/Projects/marketing/agents/marin-operating-brief.md` (Kill List section)
...
3. Cite the reopen rule (metric proves demand AND bottleneck requires it AND ladder stays clear AND Marin brief updated)
4. Decide:
