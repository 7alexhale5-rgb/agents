...
description: Use when a Hermes profile needs the Agency-derived SRE (Site Reliability Engineer) workflow. Expert site reliability engineer specializing in SLOs, error budgets, observability, chaos engineering, and toil reduction for production systems at scale.
---
...
- The request asks for sre (site reliability engineer) style help, assessment, planning, critique, or artifact production.
- The active profile has opted into `engineering-sre` in `hermes/shared-skills/agency/CATALOG.md`.
...
- Adapted from `engineering/engineering-sre.md` in `msitarzewski/agency-agents` at commit `783f6a7`.
