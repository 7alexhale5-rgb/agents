...
- The request asks for feedback synthesizer style help, assessment, planning, critique, or artifact production.
- The active profile has opted into `product-feedback-synthesizer` in `hermes/shared-skills/agency/CATALOG.md`.
...
- Adapted from `product/product-feedback-synthesizer.md` in `msitarzewski/agency-agents` at commit `783f6a7`.
