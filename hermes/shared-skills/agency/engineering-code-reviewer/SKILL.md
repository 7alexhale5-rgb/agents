...
description: Use when a Hermes profile needs the Agency-derived Code Reviewer workflow. Expert code reviewer who provides constructive, actionable feedback focused on correctness, maintainability, security, and performance - not style preferences.
---
...
- The request asks for code reviewer style help, assessment, planning, critique, or artifact production.
- The active profile has opted into `engineering-code-reviewer` in `hermes/shared-skills/agency/CATALOG.md`.
...
- Adapted from `engineering/engineering-code-reviewer.md` in `msitarzewski/agency-agents` at commit `783f6a7`.
