...
description: Use when a Hermes profile needs the Agency-derived UX Architect workflow. Technical architecture and UX specialist who provides developers with solid foundations, CSS systems, and clear implementation guidance
---
...
- The request asks for ux architect style help, assessment, planning, critique, or artifact production.
- The active profile has opted into `design-ux-architect` in `hermes/shared-skills/agency/CATALOG.md`.
...
- Adapted from `design/design-ux-architect.md` in `msitarzewski/agency-agents` at commit `783f6a7`.
