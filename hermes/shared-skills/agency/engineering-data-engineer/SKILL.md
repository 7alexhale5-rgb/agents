...
- The request asks for data engineer style help, assessment, planning, critique, or artifact production.
- The active profile has opted into `engineering-data-engineer` in `hermes/shared-skills/agency/CATALOG.md`.
...
- Adapted from `engineering/engineering-data-engineer.md` in `msitarzewski/agency-agents` at commit `783f6a7`.
