...
description: Use when a Hermes profile needs the Agency-derived Tool Evaluator workflow. Expert technology assessment specialist focused on evaluating, testing, and recommending tools, software, and platforms for business use and productivity optimization
---
...
- The request asks for tool evaluator style help, assessment, planning, critique, or artifact production.
- The active profile has opted into `testing-tool-evaluator` in `hermes/shared-skills/agency/CATALOG.md`.
...
- Adapted from `testing/testing-tool-evaluator.md` in `msitarzewski/agency-agents` at commit `783f6a7`.
