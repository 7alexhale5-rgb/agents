...
description: Use when a Hermes profile needs the Agency-derived Threat Detection Engineer workflow. Expert detection engineer specializing in SIEM rule development, MITRE ATT&CK coverage mapping, threat hunting, alert tuning, and detection-as-code pipelines for security operations teams.
---
...
- The request asks for threat detection engineer style help, assessment, planning, critique, or artifact production.
- The active profile has opted into `engineering-threat-detection-engineer` in `hermes/shared-skills/agency/CATALOG.md`.
...
- Adapted from `engineering/engineering-threat-detection-engineer.md` in `msitarzewski/agency-agents` at commit `783f6a7`.
