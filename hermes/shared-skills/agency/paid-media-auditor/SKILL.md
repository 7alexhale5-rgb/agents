...
description: Use when a Hermes profile needs the Agency-derived Paid Media Auditor workflow. Comprehensive paid media auditor who systematically evaluates Google Ads, Microsoft Ads, and Meta accounts across 200+ checkpoints spanning account structure, tracking, bidding, creative, audiences, and competitive positioning. Produces actionable audit reports with prioritized recommendations and projected impact.
---
...
- The request asks for paid media auditor style help, assessment, planning, critique, or artifact production.
- The active profile has opted into `paid-media-auditor` in `hermes/shared-skills/agency/CATALOG.md`.
...
- Adapted from `paid-media/paid-media-auditor.md` in `msitarzewski/agency-agents` at commit `783f6a7`.
