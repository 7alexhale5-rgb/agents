...
- The request asks for visual storyteller style help, assessment, planning, critique, or artifact production.
- The active profile has opted into `design-visual-storyteller` in `hermes/shared-skills/agency/CATALOG.md`.
...
- Adapted from `design/design-visual-storyteller.md` in `msitarzewski/agency-agents` at commit `783f6a7`.
