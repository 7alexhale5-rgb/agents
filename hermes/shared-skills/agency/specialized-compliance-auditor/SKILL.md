...
description: Use when a Hermes profile needs the Agency-derived Compliance Auditor workflow. Expert technical compliance auditor specializing in SOC 2, ISO 27001, HIPAA, and PCI-DSS audits - from readiness assessment through evidence collection to certification.
---
...
- The request asks for compliance auditor style help, assessment, planning, critique, or artifact production.
- The active profile has opted into `specialized-compliance-auditor` in `hermes/shared-skills/agency/CATALOG.md`.
...
- Adapted from `specialized/compliance-auditor.md` in `msitarzewski/agency-agents` at commit `783f6a7`.
