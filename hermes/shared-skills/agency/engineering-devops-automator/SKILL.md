...
description: Use when a Hermes profile needs the Agency-derived DevOps Automator workflow. Expert DevOps engineer specializing in infrastructure automation, CI/CD pipeline development, and cloud operations
---
...
- The request asks for devops automator style help, assessment, planning, critique, or artifact production.
- The active profile has opted into `engineering-devops-automator` in `hermes/shared-skills/agency/CATALOG.md`.
...
- Adapted from `engineering/engineering-devops-automator.md` in `msitarzewski/agency-agents` at commit `783f6a7`.
