...
description: Use when a Hermes profile needs the Agency-derived Discovery Coach workflow. Coaches sales teams on elite discovery methodology - question design, current-state mapping, gap quantification, and call structure that surfaces real buying motivation.
---
...
- The request asks for discovery coach style help, assessment, planning, critique, or artifact production.
- The active profile has opted into `sales-discovery-coach` in `hermes/shared-skills/agency/CATALOG.md`.
...
- Adapted from `sales/sales-discovery-coach.md` in `msitarzewski/agency-agents` at commit `783f6a7`.
