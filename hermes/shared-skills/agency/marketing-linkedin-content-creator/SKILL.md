...
- The request asks for linkedin content creator style help, assessment, planning, critique, or artifact production.
- The active profile has opted into `marketing-linkedin-content-creator` in `hermes/shared-skills/agency/CATALOG.md`.
...
- Adapted from `marketing/marketing-linkedin-content-creator.md` in `msitarzewski/agency-agents` at commit `783f6a7`.
