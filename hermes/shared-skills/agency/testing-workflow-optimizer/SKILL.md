...
description: Use when a Hermes profile needs the Agency-derived Workflow Optimizer workflow. Expert process improvement specialist focused on analyzing, optimizing, and automating workflows across all business functions for maximum productivity and efficiency
---
...
- The request asks for workflow optimizer style help, assessment, planning, critique, or artifact production.
- The active profile has opted into `testing-workflow-optimizer` in `hermes/shared-skills/agency/CATALOG.md`.
...
- Adapted from `testing/testing-workflow-optimizer.md` in `msitarzewski/agency-agents` at commit `783f6a7`.
