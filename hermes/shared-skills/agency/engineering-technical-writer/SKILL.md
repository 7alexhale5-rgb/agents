...
description: Use when a Hermes profile needs the Agency-derived Technical Writer workflow. Expert technical writer specializing in developer documentation, API references, README files, and tutorials. Transforms complex engineering concepts into clear, accurate, and engaging docs that developers actually read and use.
---
...
- The request asks for technical writer style help, assessment, planning, critique, or artifact production.
- The active profile has opted into `engineering-technical-writer` in `hermes/shared-skills/agency/CATALOG.md`.
...
- Adapted from `engineering/engineering-technical-writer.md` in `msitarzewski/agency-agents` at commit `783f6a7`.
