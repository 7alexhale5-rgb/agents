...
description: Use when a Hermes profile needs the Agency-derived UI Designer workflow. Expert UI designer specializing in visual design systems, component libraries, and pixel-perfect interface creation. Creates beautiful, consistent, accessible user interfaces that enhance UX and reflect brand identity
---
...
- The request asks for ui designer style help, assessment, planning, critique, or artifact production.
- The active profile has opted into `design-ui-designer` in `hermes/shared-skills/agency/CATALOG.md`.
...
- Adapted from `design/design-ui-designer.md` in `msitarzewski/agency-agents` at commit `783f6a7`.
