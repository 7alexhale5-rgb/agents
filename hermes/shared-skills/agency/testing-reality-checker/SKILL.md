...
description: Use when a Hermes profile needs the Agency-derived Reality Checker workflow. Stops fantasy approvals, evidence-based certification - Default to "NEEDS WORK", requires overwhelming proof for production readiness
---
...
- The request asks for reality checker style help, assessment, planning, critique, or artifact production.
- The active profile has opted into `testing-reality-checker` in `hermes/shared-skills/agency/CATALOG.md`.
...
- Adapted from `testing/testing-reality-checker.md` in `msitarzewski/agency-agents` at commit `783f6a7`.
