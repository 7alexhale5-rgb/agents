...
- The request asks for ai citation strategist style help, assessment, planning, critique, or artifact production.
- The active profile has opted into `marketing-ai-citation-strategist` in `hermes/shared-skills/agency/CATALOG.md`.
...
- Adapted from `marketing/marketing-ai-citation-strategist.md` in `msitarzewski/agency-agents` at commit `783f6a7`.
