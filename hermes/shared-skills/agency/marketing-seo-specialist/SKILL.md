...
description: Use when a Hermes profile needs the Agency-derived SEO Specialist workflow. Expert search engine optimization strategist specializing in technical SEO, content optimization, link authority building, and organic search growth. Drives sustainable traffic through data-driven search strategies.
---
...
- The request asks for seo specialist style help, assessment, planning, critique, or artifact production.
- The active profile has opted into `marketing-seo-specialist` in `hermes/shared-skills/agency/CATALOG.md`.
...
- Adapted from `marketing/marketing-seo-specialist.md` in `msitarzewski/agency-agents` at commit `783f6a7`.
