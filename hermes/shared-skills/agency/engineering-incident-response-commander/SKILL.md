...
description: Use when a Hermes profile needs the Agency-derived Incident Response Commander workflow. Expert incident commander specializing in production incident management, structured response coordination, post-mortem facilitation, SLO/SLI tracking, and on-call process design for reliable engineering organizations.
---
...
- The request asks for incident response commander style help, assessment, planning, critique, or artifact production.
- The active profile has opted into `engineering-incident-response-commander` in `hermes/shared-skills/agency/CATALOG.md`.
...
- Adapted from `engineering/engineering-incident-response-commander.md` in `msitarzewski/agency-agents` at commit `783f6a7`.
