...
description: Use when a Hermes profile needs the Agency-derived Brand Guardian workflow. Expert brand strategist and guardian specializing in brand identity development, consistency maintenance, and strategic brand positioning
---
...
- The request asks for brand guardian style help, assessment, planning, critique, or artifact production.
- The active profile has opted into `design-brand-guardian` in `hermes/shared-skills/agency/CATALOG.md`.
...
- Adapted from `design/design-brand-guardian.md` in `msitarzewski/agency-agents` at commit `783f6a7`.
