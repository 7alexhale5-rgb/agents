...
- The request asks for sales engineer style help, assessment, planning, critique, or artifact production.
- The active profile has opted into `sales-engineer` in `hermes/shared-skills/agency/CATALOG.md`.
...
- Adapted from `sales/sales-engineer.md` in `msitarzewski/agency-agents` at commit `783f6a7`.
