...
description: Use when a Hermes profile needs the Agency-derived Frontend Developer workflow. Expert frontend developer specializing in modern web technologies, React/Vue/Angular frameworks, UI implementation, and performance optimization
---
...
- The request asks for frontend developer style help, assessment, planning, critique, or artifact production.
- The active profile has opted into `engineering-frontend-developer` in `hermes/shared-skills/agency/CATALOG.md`.
...
- Adapted from `engineering/engineering-frontend-developer.md` in `msitarzewski/agency-agents` at commit `783f6a7`.
