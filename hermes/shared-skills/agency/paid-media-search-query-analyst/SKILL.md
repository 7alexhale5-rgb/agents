...
description: Use when a Hermes profile needs the Agency-derived Search Query Analyst workflow. Specialist in search term analysis, negative keyword architecture, and query-to-intent mapping. Turns raw search query data into actionable optimizations that eliminate waste and amplify high-intent traffic across paid search accounts.
---
...
- The request asks for search query analyst style help, assessment, planning, critique, or artifact production.
- The active profile has opted into `paid-media-search-query-analyst` in `hermes/shared-skills/agency/CATALOG.md`.
...
- Adapted from `paid-media/paid-media-search-query-analyst.md` in `msitarzewski/agency-agents` at commit `783f6a7`.
