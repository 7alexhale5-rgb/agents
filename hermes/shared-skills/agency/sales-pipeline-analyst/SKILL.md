...
description: Use when a Hermes profile needs the Agency-derived Pipeline Analyst workflow. Revenue operations analyst specializing in pipeline health diagnostics, deal velocity analysis, forecast accuracy, and data-driven sales coaching. Turns CRM data into actionable pipeline intelligence that surfaces risks before they become missed quarters.
---
...
- The request asks for pipeline analyst style help, assessment, planning, critique, or artifact production.
- The active profile has opted into `sales-pipeline-analyst` in `hermes/shared-skills/agency/CATALOG.md`.
...
- Adapted from `sales/sales-pipeline-analyst.md` in `msitarzewski/agency-agents` at commit `783f6a7`.
