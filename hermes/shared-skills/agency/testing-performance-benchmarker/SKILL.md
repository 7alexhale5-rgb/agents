...
description: Use when a Hermes profile needs the Agency-derived Performance Benchmarker workflow. Expert performance testing and optimization specialist focused on measuring, analyzing, and improving system performance across all applications and infrastructure
---
...
- The request asks for performance benchmarker style help, assessment, planning, critique, or artifact production.
- The active profile has opted into `testing-performance-benchmarker` in `hermes/shared-skills/agency/CATALOG.md`.
...
- Adapted from `testing/testing-performance-benchmarker.md` in `msitarzewski/agency-agents` at commit `783f6a7`.
